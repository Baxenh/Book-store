...
builder.Services.AddDefaultIdentity<WebShopUserDBContext>(options => options.SignIn.RequireConfirmedAccount = true).AddEntityFrameworkStores<WebShopDbContext>();
