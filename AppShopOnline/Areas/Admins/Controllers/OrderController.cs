...
namespace AppShopOnline.Areas.Admins.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public OrderController(AppShopOnlineDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CustomerId,Name,Email,Address,CreatedDate,Status")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CustomerId,Name,Email,Address,CreatedDate,Status")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppShopOnlineDbContext.Orders'  is null.");
            }
            var order = await _context.Orders.FindAsync(id);
            if (order != null)
            {
